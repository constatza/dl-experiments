...
_HEADER = "| ε | Expected | Actual | Diff | Status |\n|---|----------|--------|------|--------|\n"
...
def append_result(
    ...
    """Append a result row to case markdown file.

    Creates file fresh when epsilon=0.0 (first in parametrization), appends otherwise.

    Args:
        filename: Output filename (e.g., "case1.md").
        epsilon: Perturbation magnitude.
        expected: Expected iteration count from paper.
        actual: Actual iteration count from solver.
    ...
    row = f"| {epsilon:.4f} | {expected} | {actual} | {diff:+d} | {status} |\n"
