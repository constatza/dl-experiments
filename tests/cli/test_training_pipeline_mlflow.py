"""End-to-end training pipeline test with MLflow enabled."""
...
class TestTrainingPipelineWithMLflow:
    ...
    def test_full_training_pipeline_with_mlflow(self, training_setup: dict):
    ...
    def test_mlflow_nested_structure_ready(self, training_setup: dict):
    ...
    def test_mlflow_configuration_injection(self, training_setup: dict):
