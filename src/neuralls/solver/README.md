...
```python
from neuralls.solver import ConjugateGradientSolver
from neuralls.solver.strategies.direction import OrthogonalizationDirectionStrategy
...
That boundary is still comparatively clean, which is why the extraction TODO
belongs in `src/neuralls/solver/__init__.py`.
