...
Example:
    ...
    >>> import numpy as np
    >>> from neuralls.solver.utils.export import quick_export, ArrayFormat
    ...
    >>> from neuralls.solver.utils.export import save_solver_data
    >>> save_solver_data(
...
def save_solver_data(
    ...
    Example:
        >>> from pathlib import Path
        >>> import numpy as np
        >>> from neuralls.solver.utils.export import save_solver_data, ArrayFormat
        >>> from neuralls.solver.models.config import SolverConfig
        >>> from neuralls.solver.models.result import SolverResult
        >>> from neuralls.solver.monitoring.trace_mode import TraceMode
        >>> config = SolverConfig(
