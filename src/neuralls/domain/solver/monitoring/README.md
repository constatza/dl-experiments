...
**Example**:
```python
from neuralls.domain.solver.monitoring import IterationHistory, TraceMode
...
**Example**:
```python
from neuralls.domain.solver.monitoring import EventLog, EventType
...
```python
from neuralls.domain.solver.monitoring import ScalarHistory
...
```python
import numpy as np
from neuralls.domain.solver.monitoring import VectorHistory
...
**Usage**:
```python
from neuralls.domain.solver.monitoring import ResidualHistoryTracker
...
**Example**:
```python
from neuralls.domain.solver.monitoring import TraceMode
...
```python
from neuralls.domain.solver.solvers import FlexibleCGSolver
from neuralls.domain.solver.monitoring import IterationHistory, EventLog, TraceMode
...
```python
from neuralls.domain.solver.solvers import SciPyCGSolver
from neuralls.domain.solver.monitoring import IterationHistory, EventLog
...
```python
# OLD
from neuralls.domain.solver.monitoring import TraceRecorder
